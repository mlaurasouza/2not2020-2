...
for (let i = 0; i < estadosNe.length; i++) {
    estadosNe[i]['densidade demográfica']=
        densidadeDemografica(estadosNe[i].area, estadosNe[i].populacao)
    delete estadosNe[i].sigla
}

console.log(estadosNe[2])

/* 4) Escreva uma arrow function que receba um objeto. Na função, use for..in
      para extrair as propriedades e seus valores e exibi-los com console.log().
*/

let propriedades = estado => {
...
vetor.splice(2,0,estado6.nome)
vetor.splice(3,0,estado8.nome)
vetor.splice(4,0,estado4.nome)
vetor.splice(5,0,estado5.nome)
vetor.splice(6,0,estado7.nome)
vetor.splice(7,0,estado3.nome)
